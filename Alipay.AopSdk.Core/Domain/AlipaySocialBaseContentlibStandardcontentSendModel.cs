...
namespace Alipay.AopSdk.Core.Domain
{
    ...
    /// </summary>
    [Serializable]
    public class AlipaySocialBaseContentlibStandardcontentSendModel : AopObject
    {
        /// <summary>
        ...
        /// </summary>
        [XmlElement("source_thumbnail_type")]
