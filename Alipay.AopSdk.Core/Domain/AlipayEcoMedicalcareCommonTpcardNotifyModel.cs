...
namespace Alipay.AopSdk.Core.Domain
{
	...
	public class AlipayEcoMedicalcareCommonTpcardNotifyModel : AopObject
	{
		...
		/// <summary>
		///     通知业务模板样式编码，根据业务增加会增加模板类型  sv_remind_reg 预约挂号  sv_remind_clinic 诊间缴费  sv_remind_answer 问诊首次答复  sv_remind_report 报告已出
		///     sv_remind_vaccine 疫苗接种  sv_app_doctors_say 名医说
		/// </summary>
