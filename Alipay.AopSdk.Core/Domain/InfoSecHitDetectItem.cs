...
namespace Alipay.AopSdk.Core.Domain
{
	...
	public class InfoSecHitDetectItem : AopObject
	{
		...
		/// <summary>
		///     RULEORMODEL("RULEORMODEL", "规则或模型"),    KEYWORDS("KEYWORDS", "关键字检测 "),    REPEAT_MODEL("REPEAT_MODEL", "防重复模型"),
		///     REGEX("regex", "正则表达式"),    URL("url", "URL检测"),    SEXY_PIC("sexyPic", "黄图检测"),    SAMPLE_PIC("samplePic",
