...
namespace Alipay.AopSdk.Core.Domain
{
	...
	{
		/// <summary>
		///     可选：  true / false 。  当is_include_cognate = true ， 指定pid为空， 查询商户下所有pid的店铺  当is_include_cognate = true
		///     ，指定pid不为空时，查询指定pid的店铺  当is_include_cognate = false ，指定pid为空时，   查询当前商pid的店铺  当is_include_cognate = false
		///     ，指定pid不为空时，查询指定pid的店铺
		/// </summary>
