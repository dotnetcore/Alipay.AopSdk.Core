...
namespace Alipay.AopSdk.Core.Domain
{
	...
	{
		/// <summary>
		///     支付宝车型库品牌背景图片，尺寸750 x 448（modify_type参数的值为brand时此参数必填）图片url可以通过【通用图片上传接口】alipay.eco.mycar.image.upload 上传完成后获取,
		///     图片url需要进行URLencode进行转码
		/// </summary>
		...
		/// <summary>
		///     支付宝车型库品牌图片，尺寸220 x 147 （modify_type参数的值为brand时此参数必填）品牌图片url可以通过【通用图片上传接口】alipay.eco.mycar.image.upload上传完成后获取,
		///     图片url需要进行URLencode进行转码
		/// </summary>
		...
		/// <summary>
		///     支付宝车型库车系logo图片链接地址，尺寸220 x 147 （modify_type参数的值为serie时此参数必填）图片url可以通过【通用图片上传接口】alipay.eco.mycar.image.upload
		///     上传完成后获取,图片url需要进行URLencode进行转码
		/// </summary>
