...
namespace Alipay.AopSdk.Core.Domain
{
	...
	public class IsvShopDishModel : AopObject
	{
		...
		/// <summary>
		///     商家定义菜品的分类名称
		///     alipay.offline.provider.shopaction.record回传点菜中的dishTypeName，建议ISV在拿到推荐的菜品的ID后，直接使用自己的菜品元数据，口碑元数据是ISV上传，实时性无法保证。
		/// </summary>
		...
		/// <summary>
		///     菜品显示的单位（份/斤/杯）
		///     alipay.offline.provider.shopaction.record回传点菜中的unit，建议ISV在拿到推荐的菜品的ID后，直接使用自己的菜品元数据，口碑元数据是ISV上传，实时性无法保证。
		/// </summary>
		[JsonProperty("unit")]
