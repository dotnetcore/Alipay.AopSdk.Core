...
namespace Alipay.AopSdk.Core.Domain
{
    ...
    public class AlipayOpenMiniPlanOperateCreateModel : AopObject
    {
        ...
        /// 投放配置场景内容
        /// </summary>
        [XmlArray("plan_content")]
        [XmlArrayItem("plan_operate_content")]
