...
namespace Alipay.AopSdk.Core.Domain
{
	...
	public class KoubeiMarketingDataMallIndicatorQueryModel : AopObject
	{
		...
		/// <summary>
		///     业务类型，目前可选值有5个  1，mallIndustryMemberStatistics 商户会员统计信息  2，mallIndustryTradeStatistics 行业交易统计信息
		///     3，mallIndustryEventStatistics 行业活动统计信息  4，mallIndustryInfo 最新的行业维表信息  5，mallIndustryConsumptionStatistics
		///     MALL消费能力统计信息
		/// </summary>
		[XmlElement("biz_type")]
