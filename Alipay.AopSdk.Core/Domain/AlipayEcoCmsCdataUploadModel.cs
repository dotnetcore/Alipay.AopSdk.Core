...
namespace Alipay.AopSdk.Core.Domain
{
	...
	public class AlipayEcoCmsCdataUploadModel : AopObject
	{
		...
		/// <summary>
		///     消息数据,json格式,内容由模板参数列表定义.  {"占位符":"参数值","占位符2":"参数值"…}    若需要同步域内时:  场景的数据表示. json 数组  格式，根据不同的scene_code,
		///     op_code,channel,version共同确定  参数是否可以为空，接入时由支付宝确定  参数格式。
		/// </summary>
