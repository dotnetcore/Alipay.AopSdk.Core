...
namespace Alipay.AopSdk.Core.Domain
{
    ...
    /// </summary>
    [Serializable]
    public class AlipayPcreditHuabeiDiscountSolutionCreateModel : AopObject
    {
        /// <summary>
        ...
        /// </summary>
        [XmlArray("budget_warning_mail_list")]
        [XmlArrayItem("string")]
        ...
        /// </summary>
        [XmlArray("budget_warning_mobile_no_list")]
        [XmlArrayItem("string")]
